<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="医院位置" prop="departmentPosition">
        <el-input
          v-model="queryParams.departmentPosition"
          placeholder="请输入医院位置"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="医院位置" align="center" prop="departmentPosition" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="医院位置" prop="departmentPosition">
          <el-input v-model="form.departmentPosition" placeholder="请输入医院位置" />
        </el-form-item>
        <el-form-item label="就诊时间" prop="visitTime">
...
<script>
import { listOrder, getOrder, delOrder, addOrder, updateOrder } from "@/api/yl/order";
