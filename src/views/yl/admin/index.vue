  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="性别" prop="adminGender">
        <el-input
          v-model="queryParams.adminGender"
          placeholder="请输入性别"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="adminList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="姓名" align="center" prop="adminName" />
      <el-table-column label="性别" align="center" prop="adminGender" />
      <el-table-column label="邮箱" align="center" prop="adminEmail" />
      <el-table-column label="电话" align="center" prop="adminPhone" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="性别" prop="adminGender">
          <el-input v-model="form.adminGender" placeholder="请输入性别" />
        </el-form-item>
        <el-form-item label="邮箱" prop="adminEmail">
          <el-input v-model="form.adminEmail" placeholder="请输入邮箱" />
        </el-form-item>
        <el-form-item label="电话" prop="adminPhone">
          <el-input v-model="form.adminPhone" placeholder="请输入电话" />
        </el-form-item>
      </el-form>
...
<script>
import { listAdmin, getAdmin, delAdmin, addAdmin, updateAdmin } from "@/api/yl/admin";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除管理员表编号为"' + ids + '"的数据项？').then(function() {
        return delAdmin(ids);
      }).then(() => {
        this.getList();
